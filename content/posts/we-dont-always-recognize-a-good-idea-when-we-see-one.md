...
The good news is that we don't have to rely on gut instinct alone. Research points to five strategies that can help us evaluate ideas more effectively.
...
### II. Protect originality early

Before jumping immediately to what could go wrong, ask what is genuinely different about the idea and what new opportunities that difference might create.

If you evaluate novelty only through the lens of existing practices, you can end up penalizing an idea precisely because it does something different.
...
The goal is not to predict the future perfectly. It is to make the assumptions behind your judgement more explicit.

### IV. Evaluate the idea’s weaknesses, not just its strengths

A highly original idea may need tougher questions about workability. A conventional idea may need a stronger challenge on whether it offers anything meaningfully new.

The point is to evaluate every idea against the same criteria, then use revision to strengthen the criterion on which the idea is weakest.
...
Before you throw an idea away, ask: Can this be fixed?

That small shift matters because evaluation does not have to be the end of the creative process. In fact, the process is cyclical, and evaluation can often trigger further ideation.

## The Real Skill: Knowing What to Do Next
...
In a future *Research to Practice* post, we'll dig deeper into what effective idea evaluation actually looks like, unpacking the roles of forecasting, appraisal, and revision and translating that research into practical strategies you can use when deciding which ideas to reject, revise, test, or pursue.
