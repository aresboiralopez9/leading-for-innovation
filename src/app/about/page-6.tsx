      ...
      <div className="max-w-4xl mx-auto border-t border-gray-200 dark:border-gray-800 pt-14">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
          {authors.map((author) => (
            ...
            >
              <span
                className={`relative flex items-center justify-center rounded-2xl overflow-hidden w-40 h-40 mb-5 ${author.color} text-white font-bold text-3xl`}
              >
                {author.photo ? (
                  <Image src={author.photo} alt={author.name} fill className="object-cover object-top" sizes="160px" />
                ) : (
                  author.initials
                )}
              </span>
