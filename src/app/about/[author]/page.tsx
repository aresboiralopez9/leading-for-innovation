  ...
  return (
    <div className="max-w-5xl mx-auto px-4 sm:px-6 py-16">
      <div className="max-w-2xl mx-auto">
        ...
        <div className="mb-10">
          <span
            className={`relative flex items-center justify-center rounded-full overflow-hidden w-36 h-36 mb-6 ${author.color} text-white font-bold text-4xl`}
          >
            {author.photo ? (
              <Image src={author.photo} alt={author.name} fill className="object-cover" sizes="144px" />
            ) : (
              author.initials
            )}
          </span>
